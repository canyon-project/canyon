import {Breadcrumb, Button, Divider, Input, Select, Space, Switch, Table, theme, Tooltip, Typography} from "antd";
import {HeartFilled, HeartOutlined, QuestionCircleOutlined, SettingOutlined} from "@ant-design/icons";
import {useQuery} from "@apollo/client";
import {GetProjectsDocument,ProjectRecordsModel} from "@/graphql/gen/graphql.ts";
  ...
  return <div>
    ...
    <div className={'p-3'}>
      ...
      <div      className={"overflow-hidden"}
        ...
        <Table columns={columns} dataSource={data?.getProjects.data||[]}/>
      </div>
