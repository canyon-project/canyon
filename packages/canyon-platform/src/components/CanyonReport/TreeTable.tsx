                ...
                <Table
                    ...
                    columns={[
...

                        {
                            ...
                            sorter(a, b) {
                                return (
                                    a.summary.statements.total -
                                    b.summary.statements.total
                                );
                            },
                        },
                        {
                            ...
                            sorter(a, b) {
                                return (
                                    a.summary.statements.covered -
                                    b.summary.statements.covered
                                );
                            },
                        },
                    ]
                        ...
                        .concat([
                            {
                                ...
                                sorter(a, b) {
                                    return (
                                        a.summary.statements.pct -
                                        b.summary.statements.pct
                                    );
                                },
                                render(text) {
                                    return (
