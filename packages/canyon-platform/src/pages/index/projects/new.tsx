...
const App: React.FC = () => {
    ...
    const [createTodo, { data, loading }] = useMutation(
        CheckProjectUrlDocument,
    );
            ...
            <Button
                ...
                onClick={() => {
                    createProject({
                        ...
                        message.success(
                            JSON.stringify(res.data?.createProject),
                        );
                        nav(
                            `/projects/${data?.checkProjectUrl.id}/getting-started`,
                        );
                    });
                }}
            >
