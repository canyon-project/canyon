...
const ProjectOverviewPage = () => {
    ...
    const { data: projectChartData, loading: projectChartDataLoading } =
        useQuery(GetProjectChartDataDocument, {
            variables: {
                projectID: pam.id as string,
                branch: "-",
            },
    ...
    const columns: ColumnsType<ProjectRecordsModel> = [
        {
            title: (
                <div>
                    <Icon
                        component={MaterialSymbolsCommitSharp}
                        className={"mr-1"}
                    />
                    Sha
                </div>
        ...
        },
        {
            title: (
                <div ref={ref1}>
                    <Tooltip
                        title={t("projects.statements_tooltip")}
                        className={"mr-2"}
                    >
                        <QuestionCircleOutlined />
                    </Tooltip>
        ...
        },
        {
            title: (
                <div ref={ref2}>
                    <Tooltip
                        title={t("projects.newlines_tooltip")}
                        className={"mr-2"}
                    >
                        <QuestionCircleOutlined />
                    </Tooltip>
        ...
        <div className={""}>
            ...
            <div className={"flex mb-10"}>
                <Spin spinning={projectCompartmentDataLoading}>
                    ...
                    >
                        {(
                            projectCompartmentDataData?.getProjectCompartmentData ||
                            []
                        ).map((item, index) => {
                            return (
                                <div
                    ...
                    {["#1f77b4", "#ff7f0e", "#2ca02c"].map((item, index) => {
                        return (
                            ...
                            >
                                <span
                                    className={
                                        "block w-[20px] h-[12px] rounded-sm"
                                    }
