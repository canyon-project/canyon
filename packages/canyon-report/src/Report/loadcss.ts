...
#canyon-report.dark .red.solid,
#canyon-report.dark .status-line.low,
#canyon-report.dark .low .cover-fill {
  background: #BF3030;
}

#canyon-report.dark .low .chart {
  border: 1px solid #BF3030;
}

#canyon-report.dark .highlighted,
#canyon-report.dark .highlighted .cstat-no,
#canyon-report.dark .highlighted .fstat-no,
#canyon-report.dark .highlighted .cbranch-no {
  background: #BF3030 !important;
}

#canyon-report.dark .cstat-no,
#canyon-report.dark .fstat-no,
#canyon-report.dark .cbranch-no,
#canyon-report.dark .cbranch-no {
  background: #A60000;
}

#canyon-report.dark .low,
#canyon-report.dark .cline-no {
  background: #A60000;
}
...
/*#canyon-report.dark .high,*/
/*#canyon-report.dark .cline-yes {*/
/*  background: green;*/
/*}*/
...
#canyon-report.dark .cstat-yes {
  background: #4d9221;
}

#canyon-report.dark .status-line.high,
#canyon-report.dark .high .cover-fill {
  background: #00cc00;
}

#canyon-report.dark .high .chart {
...
#canyon-report.dark .status-line.medium,
#canyon-report.dark .medium .cover-fill {
  background: #FFd300;
}

#canyon-report.dark .medium .chart {
  border: 1px solid #FFd300;
}

#canyon-report.dark .medium {
  background: #A68900;
}
