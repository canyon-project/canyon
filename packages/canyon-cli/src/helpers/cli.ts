...
const args: ICLIArgument[] = [
  ...
  },
  {
    ...
    type: 'boolean',
    default: false,
    description: "Don't upload files to Canyon",
  },
  {
    alias: 'e',
    name: 'env',
    description: 'Specify environment variables to be included with this build.\nAlso accepting environment variables: CANYON_ENV=VAR,VAR2',
  },
  {
    alias: 'f',
    name: 'file',
  ...
  },
  {
    name: 'fullReport',
    type: 'string',
    description: 'Specify the path to a previously uploaded Canyon report'
  },
  {
    alias: 'F',
    name: 'flags',
  ...
  },
  {
    ...
    name: 'networkFilter',
    type: 'string',
    description: 'Specify a filter on the files listed in the network section of the Canyon report. Useful for upload-specific path fixing',
  },
  {
    alias: 'k',
    name: 'networkPrefix',
    type: 'string',
    description: 'Specify a prefix on files listed in the network section of the Canyon report. Useful to help resolve path fixing',
  },
  {
    alias: 'n',
    name: 'name',
    type: 'string',
    default: '',
    description: 'Custom defined name of the upload. Visible in Canyon UI',
  },
  {
    alias: 'N',
    name: 'parent',
  ...
  },
  {
    ...
    type: 'string',
    default: '',
    description: `Used internally by Canyon, this argument helps track
  ...
  },
  {
    ...
    type: 'string',
    default: '',
    description: 'Canyon upload token',
  },
  {
    alias: 'U',
    name: 'upstream',
