...
export interface UploaderArgs {
  ...
  dryRun?: string // Don't upload files to Canyon
  ...
  fullReport?: string // Specify the path to a previously uploaded Canyon report
  ...
  name?: string // Custom defined name of the upload. Visible in Canyon UI
  networkFilter?: string // Specify a prefix on the files listed in the network section of the Canyon report. Useful for upload-specific path fixing
  networkPrefix?: string // Specify a prefix on files listed in the network section of the Canyon report. Useful to help resolve path fixing
  ...
  token?: string // Canyon upload token
