...
```yaml
# Prisma Config
DATABASE_URL=postgres://username:password@localhost:5433/dbname
```
...
To run Canyon with Docker, you only need to specify the environment variable file path and port number
