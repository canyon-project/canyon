...
NOTE: The callback address is `<CANYON_SERVER>/oauth`, please make sure it is configured correctly in GitLab.
...
<Callout type="info" emoji="ℹ️">
  [Configure GitLab as OAuth 2.0 Authentication Identity Provider](https://docs.gitlab.com/ee/integration/oauth_provider.html)
</Callout>
