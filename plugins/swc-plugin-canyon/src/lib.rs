    ...
    fn visit_mut_module(&mut self, module: &mut Module) {
        ...
        if !self.injected {
            let window_canyon = Expr::Member(MemberExpr {
                ...
                prop: MemberProp::Ident(IdentName::from(Ident::from(Ident::new("__canyon__".into(), Default::default(), Default::default())))),
            ...
            let object_lit = Expr::Object(ObjectLit {
                props: vec![
                    Prop::KeyValue(KeyValueProp {
                        key: PropName::Ident(IdentName::from(Ident::from(Ident::new("dsn".into(), Default::default(), Default::default())))),
                        value: Box::new(Expr::Lit(Lit::Str(dsn.into()))),
                }).into(),

                    Prop::KeyValue(KeyValueProp {
                        key: PropName::Ident(IdentName::from(Ident::from(Ident::new("reporter".into(), Default::default(), Default::default())))),
                        value: Box::new(Expr::Lit(Lit::Str(reporter.into()))),
                }).into(),

                        Prop::KeyValue(KeyValueProp {
                            key: PropName::Ident(IdentName::from(Ident::from(Ident::new("instrumentCwd".into(), Default::default(), Default::default())))),
                            value: Box::new(Expr::Lit(Lit::Str(instrumentCwd.into()))),
                    }).into(),

                        Prop::KeyValue(KeyValueProp {
                            key: PropName::Ident(IdentName::from(Ident::from(Ident::new("branch".into(), Default::default(), Default::default())))),
                            value: Box::new(Expr::Lit(Lit::Str(branch.into()))),
                    }).into(),

                        Prop::KeyValue(KeyValueProp {
                            key: PropName::Ident(IdentName::from(Ident::from(Ident::new("sha".into(), Default::default(), Default::default())))),
                            value: Box::new(Expr::Lit(Lit::Str(sha.into()))),
                    }).into(),

                        Prop::KeyValue(KeyValueProp {
                            key: PropName::Ident(IdentName::from(Ident::from(Ident::new("projectID".into(), Default::default(), Default::default())))),
                            value: Box::new(Expr::Lit(Lit::Str(projectID.into()))),
                    }).into(),

                        Prop::KeyValue(KeyValueProp {
                            key: PropName::Ident(IdentName::from(Ident::from(Ident::new("compareTarget".into(), Default::default(), Default::default())))),
