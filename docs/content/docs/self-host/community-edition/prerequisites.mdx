...
Canyon is a self-hosted API development platform packaged as a set of Docker containers. You can install and run Canyon on any operating system that can run [Docker Engine](https://docs.docker.com/engine). You can use Canyon on your local computer or on a cloud provider of your choice.
