...
<Callout type="info" emoji="ℹ️">
  [将 GitLab 配置为 OAuth 2.0
  认证身份提供商](https://docs.gitlab.com/ee/integration/oauth_provider.html)
</Callout>
...
<Callout type="info" emoji="ℹ️">
  [生成 GitLab
  私有令牌](https://docs.gitlab.com/user/profile/personal_access_tokens/#create-a-personal-access-token)
</Callout>
