...
In this case, you need to use [Separate Hit and Map](/docs/core-concepts/separate-hit-and-map). Through Tools CLI, detect local sourceMap files during the build phase, and Canyon will match and upload them with initial coverage data.
