...
- After UI automation completes, use [Tools CLI](/docs/ecosystem/tools-cli) to read coverage data from local `.canyon_output` directory and aggregate for reporting.
