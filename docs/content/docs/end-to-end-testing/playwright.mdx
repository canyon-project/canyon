...
In Playwright, get the context, write coverage data to local files when test cases execute, and finally use the canyon-uploader tool to aggregate and report.
...
Use the canyon-uploader tool to aggregate and report. For specific usage, see the [canyon-uploader](/docs/ecosystem/canyon-uploader) documentation.
